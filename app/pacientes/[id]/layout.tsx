...
export default function PacienteLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      {/* HEADER TRANSLÚCIDO PARA QUE RESPIRE CON EL FONDO */}
      <header className="bg-white/95 backdrop-blur-md sticky top-0 z-40 border-b border-slate-200 shadow-sm print:hidden flex flex-col">
      ...
      <div className="px-6 py-8 max-w-[95%] mx-auto w-full flex-1 print:p-0 text-left">
        <div className="flex flex-col gap-6 print:block print:w-full text-left h-full">
          {esFicha && (
            <nav className="bg-white/80 backdrop-blur-md p-1.5 rounded-2xl border border-slate-200 flex items-center gap-1 overflow-x-auto no-scrollbar shadow-sm sticky top-[130px] z-30 print:hidden text-left">
